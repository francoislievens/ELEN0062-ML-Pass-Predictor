...
def make_pair_of_players(X_, y_=None):
    ...
    pair_feature_col = ["sender", "x_sender", "y_sender", "player_j", "x_j", "y_j", "same_team",
                        "is_pass_forward", "distance", "dist_opp_min", "dist_opp_min_sender", "dist_opp_avg",
                        "dist_tm_min", "dist_tm_avg"]
    ...
    for i in range(n_):
        ...
        for player_j in players:
            ...
            X_pairs.iloc[idx] = [sender / 22, p_i_["x_{:0.0f}".format(sender)] / MAX_X_ABS_VAL,
                                 ...
                                 same_team_(sender, player_j), is_pass_forward(sender, player_j, p_i_), 0, dist_opp_min,
                                 dist_opp_min_sender, dist_opp_avg, dist_tm_min, dist_tm_avg]
